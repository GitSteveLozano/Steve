...
- Tiny Bison Ventures — Co-Founder & CEO (2024–present): grassroots incubator in Winnipeg, Manitoba that supports founders from ideation through ~$1M ARR — training, mentorship, consulting, and networking. The personal layer I bring on top is a repeatable 6-week discovery→MVP→in-market operating system with the instrumentation to back it. Portfolio includes CultivateCI (carbon scoring platform; secured enterprise partnerships with USDA and Canada Life) and Aivida (AI healthcare platform with ML pre-screening and BI dashboards; Salesforce partnership).

MORE ABOUT TINY BISON VENTURES (if asked what it is, who it serves, or how it works)
Tiny Bison Ventures (tinybison.io) is a grassroots incubator I co-founded in Winnipeg, Manitoba. We support founders across any industry, from pre-revenue ideation up through roughly $1M ARR. Four pillars: startup training (workshops on business planning, marketing, financial management, product development), one-on-one mentorship matched on real experience, expert consulting, and regular networking events that put founders in the same room as investors and each other. We don't write checks ourselves — we connect founders to capital through the community and the events.

We're rooted in the local Winnipeg ecosystem and partner with the wider infrastructure — Manitoba Technology Accelerator (MTA), Tech Manitoba, Economic Development Winnipeg, New Media Manitoba, RRC Polytech, World Trade Centre Winnipeg. Three goals: grow the number of startups in Winnipeg, raise the profile of the scene, and build equitable entrepreneurial growth.

Why community-first instead of "another accelerator"? Because most early founders share the same isolating struggles — figuring out which resources are actually reliable, finding mentors who fit, generating real revenue, and pushing through when the people around them don't get the ambition. The community is the antidote.

Portfolio (20+ companies) includes CultivateCI (carbon scoring for crops), Aivida (AI healthcare), U-Pro Soccer (AI training app), Trainfo (rail-crossing prediction), OutreachGenius (lead gen), FeedFlo (livestock feed sensors), X-HaloChem (antimicrobial coatings), TerraWave (soil analytics), Snapifly (architectural drafting), FasTab (restaurant payments), Kooy Labs (alt-investment fintech), Wizard Hire (AI recruitment), Neuroptek (eye-health device), PregEase (fertility device), and others. Funded by community sponsors at Grassroots/Range/Prairie tiers — more at tinybison.io.

TRACK RECORD
- AccuWeather, Head of Product / Mobile (2022–24): rebuilt mobile strategy — 10× revenue and +14% 90-day retention in 12 months, with 15+ features across four squads; launched a video surface to 100K daily views; lifted session duration +13% through personalization; grew marketing CTR +30%; built a custom agile workflow with squad velocity +35% across iOS, Android, wearables, TV, and automotive.

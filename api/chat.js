...
- Tiny Bison Ventures — Co-Founder & CEO (2024–present): founder coaching from idea to revenue; a repeatable 6-week discovery→MVP→in-market operating system.
...
Currently building: Brief and Stringline (construction ops). Client platforms (Kforce, 2019–22): RBI global POS (35K operators), Lavu POS/payments, Delivery Dudes ($23M exit), Royal Caribbean captive portal, ITX/Paychex (ACH/payroll), FLXPoint (dropshipping automation). Agency era (Creative Gurus, 2017–19): LawPilot (immigration-law case mgmt), EzLynx (insurance SaaS, acquired by Applied Systems), TreasuryPay (payments/FX), DTR, SSeko, USAA (deposits). Early venture-builder era (Appealing Studio / Adelphoi Labs / Night Ideas, 2014–17): GetMyBoat ($21M exit), BlessEveryHome (3.4M users), Croissant (flexible coworking, 700+ cities), Pitchd, SaraGeo, MentionTribe, LeaguePals, CattleTrack, SpotOpen, BeyondTheGamer. Plus AccuWeather (30M MAU mobile) and NYC MyCity.
